...
// Funcion to find every client in our internal structure who has added the subject identified by "userID" to his stream
...
// Funcion to add a subject in our internal structure for a specific client
...
// Funcion to get the status of a specific subject, in a client strea, from our internal structure
...
// Funcion to remove one subject from one client's stream
...
//Funcion to update the status of a subject in a client stream's
